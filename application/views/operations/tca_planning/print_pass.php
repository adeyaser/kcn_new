...
<html>
<head>
    <title>TCA Entry Pass - <?= $data->assignment_no ?></title>
    <style>
        @page {
            size: 80mm auto;
            margin: 0;
...
<body>
    <div class="no-print" style="text-align: center; margin: 20px 0; display: flex; justify-content: center; gap: 10px;">
        <button onclick="window.print()" style="padding: 10px 20px; cursor: pointer; background: #000; color: #fff; border: none; font-weight: bold;">PRINT PASS</button>
        <button onclick="downloadPDF()" style="padding: 10px 20px; cursor: pointer; background: #dc2626; color: #fff; border: none; font-weight: bold;">DOWNLOAD PDF</button>
    </div>
    ...
    <script type="text/javascript">
        function downloadPDF() {
            ...
            var opt = {
                margin:       [5, 5, 5, 5], 
                filename:     'GatePass_<?= $data->assignment_no ?>.pdf',
